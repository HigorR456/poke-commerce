  ...
  if (router.isFallback) {
    return (
      <>
        ...
        <div className='notification stop'>
        </div>

        <main className='main-pokemon-skeleton-wrap loading-wrap'>
          <section>
              ...
              <div className='pokemon-wrap'>
                  ...
                  <div className='buy-wrap'>
                    <div className='rows-wrap'>
                      ...
                      <div className='button-wrap'>
                        ...
                        <button className='add-to-cart loading'></button>
                      </div>

                      <div className='claim-wrap'>
                        <div className='text-wrap loading'>
                        </div>
                ...
                <div className='second-row'>
                  <div className='description-wrap'>
                    <div className='description-title loading'></div>
                    ...
                    <div className='characteristics-title loading'>
                    </div>
    ...
    return (
      <>
        ...
        <div className={notification ? 'notification start' : 'notification stop'}>
          <AiFillCheckCircle className='icon' />
          &nbsp;
          {quantity} {info.name} added
        </div>
                ...
                <div className='first-row'>
                  ...
                  <div className='buy-wrap'>
                    <div className='rows-wrap'>
                      ...
                      <div className='button-wrap'>
                        <Link className='buy-now' href='/shopping-cart' onClick={() => handleAddToCart(info, quantity)}>
                          <button>Buy Now</button>
                        </Link>
                        <button className='add-to-cart' disabled={notification}
                          onClick={() => {
                            handleAddToCart(info, quantity);
                  ...
                  <div className='description-wrap'>
                    ...
                    <div className='characteristics'>
                      ...
                      <div className='table'>
                        ...
                        <ul>
                          <b>Types</b>
                          <div className='types'>{info.types.map((e: any) => { return <div key={e} className={'box ' + e}><li>{e}</li></div> })}</div>
                        </ul>
